...
const val FEED_MESSAGES_EMPTY_200: String = "{\"messages\":[{\"_id\":\"id\",\"message\":\"message\",\"submitter\":\"id\",\"username\":\"name\",\"timestamp\":0,\"type\":\"text\"},{\"_id\":\"id1\",\"title\":\"title\",\"description\":\"description\",\"done\":true,\"submitter\":\"id1\",\"username\":\"name1\",\"timestamp\":1,\"type\":\"task\"}]}"
...
const val USER_CARED_DEFINED_200: String = "{\"cared\":{\"_id\":\"61198ff240cec3067a66c0b1\",\"role\":\"patient\"}}"
const val USER_CARED_UNDEFINED_200: String = "{\"cared\":null}"
const val USER_UPDATE_200: String = "{\"_id\":\"update\",\"role\":\"patient\"}"
