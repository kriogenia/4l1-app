...
const val FEED_MESSAGES_EMPTY_200: String = "{\"messages\":[{\"_id\":\"id\",\"message\":\"message\",\"user\":\"id\",\"username\":\"name\",\"timestamp\":0,\"type\":\"text\"},{\"_id\":\"id1\",\"message\":\"message1\",\"user\":\"id1\",\"username\":\"name1\",\"timestamp\":1,\"type\":\"task\",\"room\":\"room\"}]}"
